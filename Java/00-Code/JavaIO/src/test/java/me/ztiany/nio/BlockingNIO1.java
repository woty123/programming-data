...
import static me.ztiany.nio.Utils.close;
...
public class BlockingNIO1 {
    ...
    public void client() {
        ...
        System.out.println(System.currentTimeMillis() + " clien close");
    }
    ...
    public void server() {
        ...
        try (ServerSocketChannel ssChannel = ServerSocketChannel.open()) {
            ...
            outChannel = FileChannel.open(Paths.get("file/text_copy.txt"), StandardOpenOption.WRITE, StandardOpenOption.CREATE);
