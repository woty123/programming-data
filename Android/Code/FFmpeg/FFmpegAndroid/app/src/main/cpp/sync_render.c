...
Java_com_ztiany_ffmpeg_android_FFmpeg_syncRender(JNIEnv *env, jobject thiz, jstring jpath,
                                                 jobject surface) {


    const char *input_cstr = (*env)->GetStringUTFChars(env, jpath, NULL);
    ...
    (*env)->ReleaseStringUTFChars(env, jpath, input_cstr);
