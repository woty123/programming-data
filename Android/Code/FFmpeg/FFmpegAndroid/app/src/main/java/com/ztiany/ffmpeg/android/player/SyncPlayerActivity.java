...
public class SyncPlayerActivity extends AppCompatActivity {
    ...
    public void mPlay1(View btn) {
        ...
        new FFmpeg().syncRender(file.getAbsolutePath(), surface);
    }
    ...
    public void mPlay2(View btn) {
        ...
        File output = new File(Environment.getExternalStorageDirectory(), "output.pcm");
        new FFmpeg().syncSound(file.getAbsolutePath(), output.getAbsolutePath());
    }
