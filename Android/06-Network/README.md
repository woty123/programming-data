...
- [MinaManager](https://github.com/jiezongnewstar/MinaManager)
- [OkSocket](https://github.com/xuuhaoo/OkSocket)
...
- [Kalle](https://github.com/yanzhenjie/Kalle)
- [RxVolley，支持RxJava，OKhttp，内置了一个RxBus](https://github.com/kymjs/RxVolley)
- [XDroidRequest](https://github.com/robinxdroid/XDroidRequest)
- [unirest](http://unirest.io/)：全平台的轻量级网络请求库
- [XHttp2](https://github.com/xuexiangjys/XHttp2)

## FTP

- [easyFTP-通过FTP轻松上传/下载任何类型的文件](https://github.com/linkindrew/easyFTP)

## 推送

- [Android推送技术研究](http://www.jianshu.com/p/584707554ed7)
- [推送讨论](https://github.com/android-cn/topics/issues/4)
- [推送技术研究](http://zhangtielei.com/posts/blog-android-push.html)
- [一套完整的开源消息推送系统，MPush！简洁、安全、支持集群。](http://www.jianshu.com/p/6ec412f940d0)
...
- [MobileIMSDK  一个专为移动端开发的原创即时通讯框架，超轻量级、高度提炼，完全基于UDP协议，支持iOS、Android、标准Java平台](https://github.com/JackJiang2011/MobileIMSDK)
- 融云
- 环信
