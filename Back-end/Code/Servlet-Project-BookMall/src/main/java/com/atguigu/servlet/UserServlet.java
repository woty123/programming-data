...
public class UserServlet extends BaseServlet {
     ...
     */
    public void regist(HttpServletRequest request, HttpServletResponse response) throws Exception, IOException {
        ...
        // 获取kaptcha的验证码
        String kaptchaToken = (String) request.getSession().getAttribute(Constants.KAPTCHA_SESSION_KEY);
        // 移除验证码，确保第二次请求匹配不上
     ...
     * @throws ServletException
     */
    public void login(HttpServletRequest request, HttpServletResponse response) throws Exception, IOException {
