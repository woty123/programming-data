...
<div id="main">
    <table>
        ...
        <c:choose>
            ...
            <c:when test="${  not empty sessionScope.cart.items }">
                ...
                <c:forEach items="${ sessionScope.cart.items }" var="item">
                    ...
                    <tr>
                        ...
                        <td><input ov="${ cartItem.count }" style="width: 35px;" class="updateItem"
                                   data="${ cartItem.id }" value="${ cartItem.count }" type="text"/>
                        </td>
            ...
            <c:otherwise>
                <tr>
                    <td colspan="5"><a href="${ pageContext.request.contextPath }">亲，购物车是空的。快去买，买，买！！！</a>
                    </td>
                </tr>
            </c:otherwise>
        </c:choose>
    ...
    <div class="cart_info">
        ...
        <c:if test="${  not empty sessionScope.cart.items }">
            ...
            <span class="cart_span">总金额<span id="cart_totalMoney"
                                             class="b_price"> ${ cart.totalMoney } </span>元</span>
