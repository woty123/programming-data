...
方案：为了支持文件传输，Packet 和 IoArgs 中的数据载体，由 byte 改为 Stream 传输。具体实现参考[示例代码](../00-Code/Imooc-Socket/Java-Socket/src/main/chat-room-v2-stream/)
...
局域网文件快传技术实战[示例代码](../00-Code/Imooc-Socket/Java-Socket/src/main/chat-room-v4-optimize/)
